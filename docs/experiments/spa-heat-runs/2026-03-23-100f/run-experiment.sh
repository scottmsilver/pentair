...
OUT_DIR="${OUT_DIR:-/home/ssilver/development/pentair/docs/experiments/spa-heat-runs/2026-03-23-100f}"
...
capture_sample() {
  ...
  curl -sS -m 5 "${BASE_URL}/api/pool" \
    | jq -c \
        ...
        '{captured_at:$captured_at, phase:$phase, elapsed_seconds:$elapsed_seconds, target_temperature:$target_temperature, spa:.spa, pool:.pool, pump:.pump, system:.system}'
}
